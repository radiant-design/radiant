  ...
  ({ theme, ownerState }) => [
    {
      ...
      ...(ownerState.size === "lg" && {
        ...
        "--Input-decorator-childHeight":
          "min(2.375rem, var(--Input-minHeight))",
  ...
  const rootProps = appendOwnerState(
    Root,
    {
      ...
      className: clsx(
        ...
        rootStateClasses,
        className,
        componentsProps.root?.className
      ),
    },
    ownerState
  );

  rootProps.ref = useForkRef(
    ref,
    useForkRef(rootProps.ref, componentsProps.root?.ref)
  );
  ...
  const inputProps = appendOwnerState(
    InputComponent,
    {
      ...
      className: clsx(
        classes.input,
        inputStateClasses,
        componentsProps.input?.className
      ),
    },
    ownerState
  );
