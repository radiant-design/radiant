    ...
    if (isVariantPalette(colorPalette)) {
      result[color] = {
        ...
        [theme.getColorSchemeSelector("light")]: {
          [cssVarPrefixVar("--palette-focusVisible")]: getCssVar(
            `palette-${color}-500`
          ),
          ...
          "--variant-plainColor": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 1)`,
          "--variant-plainHoverColor": getCssVar(`palette-${color}-600`),
          "--variant-plainHoverBg": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.12)`,
          "--variant-plainActiveBg": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.24)`,
          ...
          "--variant-outlinedColor": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 1)`,
          "--variant-outlinedBorder": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.4)`,
          ...
          "--variant-softDisabledBg": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.08)`,
        ...
        [theme.getColorSchemeSelector("dark")]: {
          ...
          "--variant-softHoverBg": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.32)`,
          "--variant-softActiveBg": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
          )} / 0.48)`,
          "--variant-softDisabledColor": `rgba(${getCssVar(
            `palette-${color}-mainChannel`
    ...
    if (isVariantPalette(colorPalette)) {
      if (color === "warning") {
        result.warning = {
          ...
          [cssVarPrefixVar("--palette-background-popup")]: getCssVar(
            `palette-${color}-100`
          ),
          [cssVarPrefixVar("--palette-background-level1")]: `rgba(${getCssVar(
            `palette-${color}-darkChannel`
        ...
        result[color] = {
          ...
          [cssVarPrefixVar("--palette-background-surface")]:
            "rgba(0 0 0 / 0.06)",
          [cssVarPrefixVar("--palette-background-popup")]: getCssVar(
            `palette-${color}-700`
          ),
          ...
          [cssVarPrefixVar("--palette-text-primary")]:
