...
import { PopperProps } from './PopperProps';
...
const Popper = React.forwardRef(function Popper(
    ...
    const props = useThemeProps<typeof inProps & PopperProps>({
        props: inProps,
        name: 'JoyPopper'
    });
    // ! commented since we currently do not have any default direction (i.e. rtl or ltl) in theme
    // const theme = useTheme<{ direction?: Direction }>();
    // return <PopperRoot direction={theme?.direction} {...props} ref={ref} />;
    return <PopperRoot direction={'rtl'} {...props} ref={ref} />;
});
